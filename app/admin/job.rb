ActiveAdmin.register Job do
  permit_params :exclusive, :title, :content, :number, :location, :date, :apply, :summary, :employer_id, :category_id, :published_at, :type_id, :apply_link, :longitude, :latitude, :apply_via_app
